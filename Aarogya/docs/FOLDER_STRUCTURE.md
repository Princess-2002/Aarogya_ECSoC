📁 Aarogya - Project Folder Structure Documentation

📋 Overview

This document provides a comprehensive overview of the Aarogya project structure, explaining the purpose of each directory and file. Understanding this structure will help you navigate the codebase efficiently and know where to place new files.
...
aarogyaAI.css	AI assistant page styles
...
aarogyaAI.js	AI chatbot and health analysis features
...
aarogyaAI.html	AI health assistant interface
...
Images	kebab-case	aarogya-logo.png
