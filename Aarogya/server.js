/**
 * ============================================
 * AAROGYA - MAIN APPLICATION SERVER
 * ============================================
 * This is the entry point for the Aarogya application.
...
app.get("/aarogyaAI", (req, res) => {
    res.sendFile(path.join(__dirname, "public", "aarogyaAI.html"));
});
